...
!cjshiu orig Dcs = 400.e-6_r8
 Dcs = 500.e-6_r8    !as tuned value of TaiESM2.1nrhc.mam3
!cjshiu  Dcs = 350.e-6_r8     
...
!cjshiu tn15 based on CMIP5 emission            npccn(k) = max(0._r8,0.9_r8*npccnin(i,k))  !cjshiu to tune down
            npccn(k) = max(0._r8,npccnin(i,k))  !cjshiu restore for CMIP6 emission
