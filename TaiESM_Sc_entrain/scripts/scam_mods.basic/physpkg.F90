...
subroutine phys_init( phys_state, phys_tend, pbuf2d, cam_out )
    ...
    call addfld( 't_ini_tphysbc', 'K'      , pver   , 'A', 't at the begining of tphysbc'          , phys_decomp )
    call addfld( 'q_ini_tphysbc', 'kg/kg'  , pver   , 'A', 'q at the begining of tphysbc'          , phys_decomp )
    call addfld( 'ql_ini_tphysbc', 'kg/kg' , pver   , 'A', 'ql at the begining of tphysbc'         , phys_decomp )
    call addfld( 'qi_ini_tphysbc', 'kg/kg' , pver   , 'A', 'qi at the begining of tphysbc'         , phys_decomp )

    call addfld( 's_ini_tphysac', 'J/kg'   , pver   , 'A', 's at the begining of tphysac'          , phys_decomp )
    call addfld( 't_ini_tphysac', 'K'      , pver   , 'A', 't at the begining of tphysac'          , phys_decomp )
    call addfld( 'q_ini_tphysac', 'kg/kg'  , pver   , 'A', 'q at the begining of tphysac'          , phys_decomp )
    call addfld( 'ql_ini_tphysac', 'kg/kg' , pver   , 'A', 'ql at the begining of tphysac'         , phys_decomp )
    call addfld( 'qi_ini_tphysac', 'kg/kg' , pver   , 'A', 'qi at the begining of tphysac'         , phys_decomp )

    call addfld( 's_aft_deep', 'J/kg'   , pver   , 'A', 's after deep convection'          , phys_decomp )
    call addfld( 't_aft_deep', 'K'      , pver   , 'A', 't after deep convection'          , phys_decomp )
    call addfld( 'q_aft_deep', 'kg/kg'  , pver   , 'A', 'q after deep convection'          , phys_decomp )
    call addfld( 'ql_aft_deep', 'kg/kg' , pver   , 'A', 'ql after deep convection'         , phys_decomp )
    call addfld( 'qi_aft_deep', 'kg/kg' , pver   , 'A', 'qi after deep convection'         , phys_decomp )

    call addfld( 's_aft_shallow', 'J/kg'   , pver   , 'A', 's after shallow convection'          , phys_decomp )
    call addfld( 't_aft_shallow', 'K'      , pver   , 'A', 't after shallow convection'          , phys_decomp )
    call addfld( 'q_aft_shallow', 'kg/kg'  , pver   , 'A', 'q after shallow convection'          , phys_decomp )
    call addfld( 'ql_aft_shallow', 'kg/kg' , pver   , 'A', 'ql after shallow convection'         , phys_decomp )
    call addfld( 'qi_aft_shallow', 'kg/kg' , pver   , 'A', 'qi after shallow convection'         , phys_decomp )

    call addfld( 's_aft_macro', 'J/kg'   , pver   , 'A', 's after macro'          , phys_decomp )
    call addfld( 't_aft_macro', 'K'      , pver   , 'A', 't after macro'          , phys_decomp )
    call addfld( 'q_aft_macro', 'kg/kg'  , pver   , 'A', 'q after macro'          , phys_decomp )
    call addfld( 'ql_aft_macro', 'kg/kg' , pver   , 'A', 'ql after macro'         , phys_decomp )
    call addfld( 'qi_aft_macro', 'kg/kg' , pver   , 'A', 'qi after macro'         , phys_decomp )

    call addfld( 's_aft_micro', 'J/kg'   , pver   , 'A', 's after micro'          , phys_decomp )
    call addfld( 't_aft_micro', 'K'      , pver   , 'A', 't after micro'          , phys_decomp )
    call addfld( 'q_aft_micro', 'kg/kg'  , pver   , 'A', 'q after micro'          , phys_decomp )
    call addfld( 'ql_aft_micro', 'kg/kg' , pver   , 'A', 'ql after micro'         , phys_decomp )
    call addfld( 'qi_aft_micro', 'kg/kg' , pver   , 'A', 'qi after micro'         , phys_decomp )

    call addfld( 's_aft_rad', 'J/kg'   , pver   , 'A', 's after radiation'          , phys_decomp )
    call addfld( 't_aft_rad', 'K'      , pver   , 'A', 't after radiation'          , phys_decomp )
    call addfld( 'q_aft_rad', 'kg/kg'  , pver   , 'A', 'q after radiation'          , phys_decomp )
    call addfld( 'ql_aft_rad', 'kg/kg' , pver   , 'A', 'ql after radiation'         , phys_decomp )
    call addfld( 'qi_aft_rad', 'kg/kg' , pver   , 'A', 'qi after radiation'         , phys_decomp )

    call addfld( 's_aft_turb', 'J/kg'   , pver   , 'A', 's after turb'          , phys_decomp )
    call addfld( 't_aft_turb', 'K'      , pver   , 'A', 't after turb'          , phys_decomp )
    call addfld( 'q_aft_turb', 'kg/kg'  , pver   , 'A', 'q after turb'          , phys_decomp )
    call addfld( 'ql_aft_turb', 'kg/kg' , pver   , 'A', 'ql after turb'         , phys_decomp )
    call addfld( 'qi_aft_turb', 'kg/kg' , pver   , 'A', 'qi after turb'         , phys_decomp )

    call addfld( 's_aft_ray', 'J/kg'   , pver   , 'A', 's after Rayleigh friction'          , phys_decomp )
    call addfld( 't_aft_ray', 'K'      , pver   , 'A', 't after Rayleigh friction'          , phys_decomp )
    call addfld( 'q_aft_ray', 'kg/kg'  , pver   , 'A', 'q after Rayleigh friction'          , phys_decomp )
    call addfld( 'ql_aft_ray', 'kg/kg' , pver   , 'A', 'ql after Rayleigh friction'         , phys_decomp )
    call addfld( 'qi_aft_ray', 'kg/kg' , pver   , 'A', 'qi after Rayleigh friction'         , phys_decomp )

    call addfld( 's_aft_gwd', 'J/kg'   , pver   , 'A', 's after gravity wave drag'          , phys_decomp )
    call addfld( 't_aft_gwd', 'K'      , pver   , 'A', 't after gravity wave drag'          , phys_decomp )
    call addfld( 'q_aft_gwd', 'kg/kg'  , pver   , 'A', 'q after gravity wave drag'          , phys_decomp )
    call addfld( 'ql_aft_gwd', 'kg/kg' , pver   , 'A', 'ql after gravity wave drag'         , phys_decomp )
    call addfld( 'qi_aft_gwd', 'kg/kg' , pver   , 'A', 'qi after gravity wave drag'         , phys_decomp )
    !---> yhc 2025-07-25
